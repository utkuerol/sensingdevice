...
public class DatastreamMapper {
    ...
    public static DatastreamPersistenceEntity toPersistenceEntity(Datastream datastream) {
        ...
        persistenceEntity.setObservations(
                datastream.getObservations().stream().map(ObservationMapper::toPersistenceEntity).toList());
    ...
    public static Datastream fromPersistenceEntity(DatastreamPersistenceEntity persistenceEntity) {
        var obs = new TreeSet<Observation>(
                persistenceEntity.getObservations().stream().map(ObservationMapper::fromPersistenceEntity).toList());
