...
public class ObservationsController implements ObservationsAPI {
    ...
    @SneakyThrows
    @Override
    public ObservationDTO createSensorObservation(String deviceId, String sensorId, ObservedProperty observedProperty,
            String value) {
        var createdObservation = observationOperations.createObservation(deviceId, sensorId, observedProperty, value);
    ...
    @SneakyThrows
    @Override
    public void deleteSensorObservationsWithObservedProperty(String deviceId, String sensorId, String observedProperty,
            Instant from, Instant to) {
        observationOperations.deleteObservationsOfSensorWithObservedProperty(deviceId, sensorId, observedProperty, from,
                to);
    }
    ...
    public DatastreamObservationsDTO getObservationsWithObservedProperty(String deviceId, String observedProperty,
            Optional<Instant> from, Optional<Instant> to) {
        var datastream = observationOperations.getObservationsWithObservedProperty(deviceId, observedProperty, from,
                to);
        return new DatastreamObservationsDTO(datastream);
    }
