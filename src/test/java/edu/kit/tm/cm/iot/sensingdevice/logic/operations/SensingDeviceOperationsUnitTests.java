...
public class SensingDeviceOperationsUnitTests {
	...
	@Test
	public void createSensingDevice() throws InvalidSensingDeviceException {
		assertEquals("serialNumber",
				sensingDeviceOperations.createSensingDevice("serialNumber", "manufacturer", "model").getSerialNumber());
		assertEquals("manufacturer",
				sensingDeviceOperations.createSensingDevice("serialNumber", "manufacturer", "model").getManufacturer());
		assertEquals("model",
				sensingDeviceOperations.createSensingDevice("serialNumber", "manufacturer", "model").getModel());
	}
	...
	public void updateSensingDevice() throws SensingDeviceNotFoundException {
		...
		assertEquals("model2",
				sensingDeviceOperations.updateSensingDevice("id", "serialNumber", "manufacturer", "model2").getModel());
	}
